...
col = ["#a6cee3","#1f78b4","#b2df8a","#33a02c","#a6cee3","#1f78b4","#b2df8a","#33a02c","#a6cee3","#1f78b4","#b2df8a","#33a02c"]
col = ["#a6611a", "#dfc27d", "#80cdc1", "#018571"]
m = 0
navn = ["TA", "TP", "EA", "MS"]
ylabel = ["","","mg/g DM", "mg/g DM"]
for i in navn:
    l = 0
    m += 1
    for j in ["2012","2013","2014"]:
        l += 1
        n = 0
        for k in ["102","306","Fjellgull","Fjordgull"]:
            n += 1
